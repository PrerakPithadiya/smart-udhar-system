...
<body style="overflow: hidden;">
    ...
    <div class="main-content">
            ...
            <div class="row">
                                                                    ...
                                                                    <td>
                                                                        <div class="udhar-row-actions">
                                                                            <a href="print_bill.php?id=<?php echo $entry['id']; ?>"
                                                                                ...
                                                                                title="Print Bill" target="_blank">
                                                ...
                                                <?php if ($total_pages > 1): ?>
                                                    <nav aria-label="Page navigation">
                                                        <ul class="pagination justify-content-center">
                                                            ...
                                                            <li
                                                                class="page-item <?php echo $page == $total_pages ? 'disabled' : ''; ?>">
                                                                <a class="page-link"
                                                                    href="?action=list&search=<?php echo urlencode($search); ?>&status=<?php echo $status_filter; ?>&customer=<?php echo $customer_filter; ?>&page=<?php echo $page + 1; ?>">
                                                                    Next
                                                                </a>
                                                    ...
                                                    <div class="bill-form-row">
                                                        <div class="bill-form-group">
                                                            <label for="customer_id"><i class="bi bi-person"></i> Customer
                                                                *</label>
                                                            <select class="bill-form-control" id="customer_id"
                                                            ...
                                                            <div class="bill-summary-card">
                                                                <table class="bill-summary-table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="summary-value"><span
                                                                                id="cgstTotal">0.00</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="summary-label">SGST:</td>
                                                                        <td class="summary-value"><span
                                                                                id="sgstTotal">0.00</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="summary-label">IGST:</td>
                                                                        <td class="summary-value"><span
                                                                                id="igstTotal">0.00</span></td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <table class="bill-info-table">
                                                                <tr>
                                                                    ...
                                                                    <td class="bill-info-value">
                                                                        ...
                                                                        ?>
                                                                        <span
                                                                            class="udhar-status-badge <?php echo $status_class; ?>">
                ...
                <script>
                    ...
                    function addItemRow(itemData = null) {
                        ...
                        // Default values - MAKE SURE UNIT IS INCLUDED
                        const defaultItem = itemData || {
                            ...
                            sgst_rate: '2.5',
                            igst_rate: '0.00',
                            unit: 'PCS' // Make sure unit is included
                        };
        ...
        <td>
            <select class="form-select item-select" name="items[${itemCounter}][item_id]" 
                ...
                ${items.map(item => `
                    <option value="${item.id}" 
                            ...
                            data-unit="${item.unit}"  <!-- Make sure unit is here -->
            ...
            <input type="hidden" name="items[${itemCounter}][hsn_code]" 
                   value="${defaultItem.hsn_code}" class="item-hsn">
            <input type="hidden" name="items[${itemCounter}][unit]" 
                   value="${defaultItem.unit}" class="item-unit">  <!-- Add hidden unit field -->
        </td>
        <td>
        ...
        <td>
            ...
            <td>
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" class="form-control cgst-rate" 
                           name="items[${itemCounter}][cgst_rate]" 
                           value="${defaultItem.cgst_rate}" step="0.01" min="0" max="100"
                           onchange="calculateItemTotal(${itemCounter})" style="width: 70px;">
                    <span class="input-group-text">%</span>
                </div>
                <div class="input-group input-group-sm mt-1">
                    <span class="input-group-text">SGST</span>
                    <input type="number" class="form-control sgst-rate" 
                ...
                <div class="input-group input-group-sm mt-1">
                    ...
                    <input type="number" class="form-control igst-rate" 
