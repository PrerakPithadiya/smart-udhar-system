                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if (!empty($customer['mobile'])): ?>
                                                                <a href="tel:<?php echo htmlspecialchars($customer['mobile']); ?>" class="text-decoration-none">
                                                                    <i class="bi bi-telephone"></i> <?php echo htmlspecialchars($customer['mobile']); ?>
                                                                </a>
                                                            <?php else: ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-floating">
                                                        <textarea class="form-control" id="address" name="address"
                                                            placeholder="Address" style="height: 100px"><?php echo $action == 'edit' && $customer ? htmlspecialchars($customer['address']) : ''; ?></textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card bg-light">
                                                            <div class="card-body">
                                                                ...
                                                                <h4 class="<?php echo $customer['balance'] > 0 ? 'text-danger' : ($customer['balance'] < 0 ? 'text-success' : 'text-muted'); ?>">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="mb-0">This action cannot be undone. All customer data including udhar history will be permanently deleted.</p>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mt-4">
                                            <a href="customers.php?action=edit&id=<?php echo $customer['id']; ?>" class="btn btn-primary btn-sm">
                                                <i class="bi bi-pencil"></i> Edit Profile
                                            </a>
                                            <a href="udhar.php?action=add&customer_id=<?php echo $customer['id']; ?>" class="btn btn-success btn-sm">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card <?php echo $customer['balance'] > 0 ? 'bg-danger' : ($customer['balance'] < 0 ? 'bg-warning' : 'bg-secondary'); ?> text-white">
                                            <div class="card-body text-center">
                                                <h6 class="card-title">Current Balance</h6>
                                ...
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="reports.php?customer_id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-outline-primary">
                                            View All
                                        </a>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    ");
                                        ...
                                        <?php if (empty($transactions)): ?>
                                            <div class="text-center py-4">
                                                ...
                                                <a href="udhar.php?action=add&customer_id=<?php echo $customer['id']; ?>" class="btn btn-primary">
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="payments.php?customer_id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-outline-primary">
                                            View All
                                        </a>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    ");
                                        ...
                                        <?php if (empty($payments)): ?>
                                            <div class="text-center py-4">
                                                ...
                                                <a href="payments.php?action=add&customer_id=<?php echo $customer['id']; ?>" class="btn btn-success">
