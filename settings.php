                ...
                <div class="col-lg-10 mx-auto">
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0 text-primary"><i class="bi bi-gear-wide-connected"></i> Application Settings
                            </h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="">
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <h6 class="text-primary mb-3"><i class="bi bi-graph-up"></i> Report Settings
                                        </h6>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="chart_type">
                                                <option value="bar" <?php echo (isset($user_settings['chart_type']) && $user_settings['chart_type'] === 'bar') ? 'selected' : ''; ?>>Bar
                                                    Chart</option>
                                                <option value="line" <?php echo (isset($user_settings['chart_type']) && $user_settings['chart_type'] === 'line') ? 'selected' : ''; ?>>Line
                                                    Chart</option>
                                                <option value="pie" <?php echo (isset($user_settings['chart_type']) && $user_settings['chart_type'] === 'pie') ? 'selected' : ''; ?>>Pie
                                                    Chart</option>
                                                <option value="area" <?php echo (isset($user_settings['chart_type']) && $user_settings['chart_type'] === 'area') ? 'selected' : ''; ?>>Area
                                                    Chart</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <h6 class="text-primary mb-3"><i class="bi bi-printer"></i> Print & Export
                                            Settings</h6>

                                        <div class="mb-3">
                                            <label class="form-label">Export Format</label>
                                            <select class="form-select" name="export_format">
                                                <option value="excel" <?php echo (isset($user_settings['export_format']) && $user_settings['export_format'] === 'excel') ? 'selected' : ''; ?>>
                                                    Excel (.xlsx)</option>
                                                <option value="pdf" <?php echo (isset($user_settings['export_format']) && $user_settings['export_format'] === 'pdf') ? 'selected' : ''; ?>>
                                                    PDF (.pdf)</option>
                                                <option value="csv" <?php echo (isset($user_settings['export_format']) && $user_settings['export_format'] === 'csv') ? 'selected' : ''; ?>>
                                                    CSV (.csv)</option>
                                                <option value="all" <?php echo (isset($user_settings['export_format']) && $user_settings['export_format'] === 'all') ? 'selected' : ''; ?>>
                                                    All Formats</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="print_format">
                                                <option value="standard" <?php echo (isset($user_settings['print_format']) && $user_settings['print_format'] === 'standard') ? 'selected' : ''; ?>>
                                                    Standard</option>
                                                <option value="compact" <?php echo (isset($user_settings['print_format']) && $user_settings['print_format'] === 'compact') ? 'selected' : ''; ?>>
                                                    Compact</option>
                                                <option value="detailed" <?php echo (isset($user_settings['print_format']) && $user_settings['print_format'] === 'detailed') ? 'selected' : ''; ?>>
                                                    Detailed</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="theme_preference">
                                                <option value="light" <?php echo (isset($user_settings['theme_preference']) && $user_settings['theme_preference'] === 'light') ? 'selected' : ''; ?>>
                                                    Light</option>
                                                <option value="dark" <?php echo (isset($user_settings['theme_preference']) && $user_settings['theme_preference'] === 'dark') ? 'selected' : ''; ?>>
                                                    Dark</option>
                                                <option value="auto" <?php echo (isset($user_settings['theme_preference']) && $user_settings['theme_preference'] === 'auto') ? 'selected' : ''; ?>>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <h6 class="text-primary mb-3"><i class="bi bi-currency-rupee"></i> Business
                                            Settings</h6>

                                        <div class="mb-3 form-check">
                                            <input type="checkbox" class="form-check-input" id="auto_calculate_tax"
                                                <?php echo (isset($user_settings['auto_calculate_tax']) && $user_settings['auto_calculate_tax'] === '1') ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="auto_calculate_tax">Auto Calculate
                                                Tax</label>
                                        </div>
                                        ...
                                        <div class="mb-3 form-check">
                                            ...
                                            <label class="form-check-label" for="round_off_amounts">Round Off
                                                Amounts</label>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <h6 class="text-primary mb-3"><i class="bi bi-bell"></i> Notification Settings
                                        </h6>

                                        <div class="mb-3 form-check">
                                            <input type="checkbox" class="form-check-input" id="email_notifications"
                                                <?php echo (isset($user_settings['email_notifications']) && $user_settings['email_notifications'] === '1') ? 'checked' : ''; ?>>
                                        ...
                                        <div class="mb-3 form-check">
                                            ...
                                            <label class="form-check-label" for="sms_notifications">SMS
                                                Notifications</label>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="reminder_days"
                                                value="<?php echo isset($user_settings['reminder_days']) ? htmlspecialchars($user_settings['reminder_days']) : '3'; ?>"
                                                min="1" max="30">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0 text-primary"><i class="bi bi-info-circle"></i> System Information</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p><strong>Server:</strong> <?php echo $_SERVER['SERVER_SOFTWARE'] ?? 'Unknown'; ?>
                                    </p>
                                    <p><strong>System:</strong> <?php echo php_uname('s') . ' ' . php_uname('r'); ?></p>
                                    <p><strong>Uptime:</strong>
                                        <?php echo floor((time() - $_SERVER['REQUEST_TIME']) / 60); ?> minutes</p>
                                </div>
                            </div>
                        </div>
                    </div>
