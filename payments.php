...
<head>
    ...
    <style>
        ...
        .mode-cash { background-color: #d4edda; color: #155724; }
        .mode-bank { background-color: #cce5ff; color: #004085; }
        .mode-upi { background-color: #d1ecf1; color: #0c5460; }
        .mode-cheque { background-color: #fff3cd; color: #856404; }
        .mode-other { background-color: #f8d7da; color: #721c24; }
        ...
        .allocated { background-color: #d4edda; color: #155724; }
        .partial { background-color: #fff3cd; color: #856404; }
        .unallocated { background-color: #f8d7da; color: #721c24; }
